...
# ==========================================
    ...
    if df_master.empty:
        ...
        # Form Header Informasi Nota Masuk
        ...
        # Layout Kolom: Kiri untuk Input, Kanan untuk Tabel Keranjang Sementara
        ...
        with col_in:
            ...
            if st.button("Tambah ke Keranjang 🛒", key="btn_add_masuk", use_container_width=True):
                if no_bukti_masuk == "":
                    ...
                    # Gabungkan info Nota ke keterangan agar aman dengan Excel lama
        ...
        with col_tbl:
            ...
            if st.session_state.keranjang_masuk:
                ...
                if c_simpan.button("💾 SIMPAN BARANG MASUK KE EXCEL", type="primary", key="save_masuk", use_container_width=True):
                    # Hanya mengambil kolom 'Tanggal', 'Kode Barang', dan 'Jumlah Masuk' agar sesuai database Excel lama kamu
        ...
        with col_in:
            ...
            if st.button("Tambah ke Daftar 🛒", key="btn_add_keluar", use_container_width=True):
                if no_bukti == "":
                    ...
                    # Satukan informasi Nota ke dalam teks Keterangan untuk menghemat struktur kolom Excel lamamu
        ...
        with col_tabel:
            ...
            if st.session_state.keranjang_keluar:
                ...
                if c_simpan.button("💾 SIMPAN BARANG KELUAR", type="primary", key="save_keluar", use_container_width=True):
                    # Ambil HANYA 4 kolom asli sesuai struktur awal database Excel kamu!
